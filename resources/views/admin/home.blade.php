...
<div class="card">
  ...
  <div class="table-responsive card-body owner-data">
  	@if( $owners->count() == 0 )
      <div style="text-align: center; height: 20%; padding-top: 5%">No registered owner available.</div>
    @else
...
<div class="card">
  ...
  <div class="table-responsive card-body url-data">
    @if( $urls->count() == 0 )
      <div style="text-align: center; height: 20%; padding-top: 5%">No public URL available.</div>
    @else
      <table class="table dt-responsive nowrap" cellspacing="0" style="font-size: 13px">
        <thead>
          <th>Team</th>
