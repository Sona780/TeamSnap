...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{url('/css/new.css')}}">
</head>
<body>
     ...
     <section class="features">
        <div class="container">
             ...
             <div class="row feature_line_1">
                    ...
                    <div class="col-sm-4">
                       <span class="glyphicon glyphicon-user gl_icon"></span>
                       <h3>
                           <a href="#">Members</a>
                       </h3>
                       <div class="">
                    ...
                    <div class="col-sm-4">
                       <span class="glyphicon glyphicon-file gl_icon"></span>
                       <h3>
                           <a href="#">Records</a>
                       </h3>
                       <div class="">
             ...
             <div class="row m-t-50">
                    ...
                    <div class="col-sm-4">
                       <span class="glyphicon glyphicon-picture gl_icon"></span>
                       <h3>
                           <a href="#">Media</a>
                       </h3>
                       <div class="">
                    ...
                    <div class="col-sm-4">
                       <span class="glyphicon glyphicon-thumbs-up gl_icon"></span>
                       <h3>
         ...
         <div class="container">
             ...
             <div class="row p-t-20">
                <div class="col-sm-5 col-sm-offset-1">
                  ...
                  <div class="text-justify get_start_content lato">
