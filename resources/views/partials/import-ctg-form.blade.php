<div class="modal-body">
	...
	<div class="form-group" id='ictg-div' style="display: none">
	    ...
	    <select class="selectpicker show-menu-arrow" data-live-search="true" data-style="grey" name="categories[]" title='Choose Categories..' id="categories" multiple="multiple">
